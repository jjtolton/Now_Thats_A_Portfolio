...
var or__6409__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj15246 = {"detail":data};
return obj15246;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__6397__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
var args15251 = [];
var len__7484__auto___15257 = arguments.length;
var i__7485__auto___15258 = (0);
while(true){
if((i__7485__auto___15258 < len__7484__auto___15257)){
args15251.push((arguments[i__7485__auto___15258]));

var G__15259 = (i__7485__auto___15258 + (1));
i__7485__auto___15258 = G__15259;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args15251.length)].join('')));
...
var f = (function (){var pred__15254 = cljs.core._EQ_;
var expr__15255 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__15254.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__15255))){
return ((function (pred__15254,expr__15255){
return (function (p1__15247_SHARP_){
return console.warn(p1__15247_SHARP_);
});
;})(pred__15254,expr__15255))
} else {
if(cljs.core.truth_(pred__15254.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__15255))){
return ((function (pred__15254,expr__15255){
return (function (p1__15248_SHARP_){
return console.debug(p1__15248_SHARP_);
});
;})(pred__15254,expr__15255))
} else {
if(cljs.core.truth_(pred__15254.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__15255))){
return ((function (pred__15254,expr__15255){
return (function (p1__15249_SHARP_){
return console.error(p1__15249_SHARP_);
});
;})(pred__15254,expr__15255))
} else {
return ((function (pred__15254,expr__15255){
return (function (p1__15250_SHARP_){
return console.log(p1__15250_SHARP_);
});
;})(pred__15254,expr__15255))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__15261){
var map__15264 = p__15261;
...
var opts = map__15264__$1;
var eval_fn = cljs.core.get.call(null,map__15264__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__15266_SHARP_);
});})(new_def))
);
...
return (function (p__15267){
var vec__15268 = p__15267;
var ky = cljs.core.nth.call(null,vec__15268,(0),null);
var v = cljs.core.nth.call(null,vec__15268,(1),null);
...
var args15271 = [];
var len__7484__auto___15274 = arguments.length;
var i__7485__auto___15275 = (0);
while(true){
if((i__7485__auto___15275 < len__7484__auto___15274)){
args15271.push((arguments[i__7485__auto___15275]));

var G__15276 = (i__7485__auto___15275 + (1));
i__7485__auto___15275 = G__15276;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args15271.length)].join('')));
