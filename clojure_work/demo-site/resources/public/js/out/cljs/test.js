...
var args46078 = [];
var len__29970__auto___46082 = arguments.length;
var i__29971__auto___46083 = (0);
while(true){
if((i__29971__auto___46083 < len__29970__auto___46082)){
args46078.push((arguments[i__29971__auto___46083]));

var G__46084 = (i__29971__auto___46083 + (1));
i__29971__auto___46083 = G__46084;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args46078.length)].join('')));
...
var G__46081 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__46081,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__46081;
}
});
...
var or__28749__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__29970__auto___46089 = arguments.length;
var i__29971__auto___46090 = (0);
while(true){
if((i__29971__auto___46090 < len__29970__auto___46089)){
args__29977__auto__.push((arguments[i__29971__auto___46090]));

var G__46091 = (i__29971__auto___46090 + (1));
i__29971__auto___46090 = G__46091;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29978__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq46086){
var G__46087 = cljs.core.first.call(null,seq46086);
var seq46086__$1 = cljs.core.next.call(null,seq46086);
var G__46088 = cljs.core.first.call(null,seq46086__$1);
var seq46086__$2 = cljs.core.next.call(null,seq46086__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__46087,G__46088,seq46086__$2);
});
...
var map__46095 = m;
var map__46095__$1 = ((((!((map__46095 == null)))?((((map__46095.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46095.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46095):map__46095);
var file = cljs.core.get.call(null,map__46095__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46095__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46095__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__46095,map__46095__$1,file,line,column){
return (function (p1__46092_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__46092_SHARP_));
});})(map__46095,map__46095__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__29780__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__29780__auto__,prefer_table__29781__auto__,method_cache__29782__auto__,cached_hierarchy__29783__auto__,hierarchy__29784__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__28749__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__28749__auto__)){
return or__28749__auto__;
} else {
...
var temp__6738__auto___46097 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6738__auto___46097)){
var message_46098 = temp__6738__auto___46097;
cljs.core.println.call(null,message_46098);
} else {
}
...
var temp__6738__auto___46099 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6738__auto___46099)){
var message_46100 = temp__6738__auto___46099;
cljs.core.println.call(null,message_46100);
} else {
}
...
var temp__6736__auto__ = (function (){var and__28737__auto__ = typeof exception.stack === 'string';
if(and__28737__auto__){
var G__46110 = exception.stack;
var G__46110__$1 = (((G__46110 == null))?null:clojure.string.split_lines.call(null,G__46110));
var G__46110__$2 = (((G__46110__$1 == null))?null:cljs.core.get.call(null,G__46110__$1,depth));
if((G__46110__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__46110__$2);
}
} else {
...
var vec__46111 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__46111,(0),null);
var column = cljs.core.nth.call(null,vec__46111,(1),null);
var vec__46114 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__46114,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__46114,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__46114,(2),null);
...
var m__$1 = (function (){var G__46118 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__46118) {
case "fail":
...
var G__46124 = (function (){var G__46123 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__46123);
} else {
return G__46123;
}
})();
...
return cljs.core.vary_meta.call(null,G__46126,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e46129){var e = e46129;
var G__46130 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__46130) {
...
var vec__46135 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__46135,(0),null);
var types = vec__46135;
...
return cljs.core.map.call(null,(function (p__46147){
var vec__46148 = p__46147;
var ns = cljs.core.nth.call(null,vec__46148,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__46148,(1),null);
return ((function (vec__46148,ns,vars__$1){
return (function (){
...
var G__46151 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__46151) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1){
return (function (){
var seq__46152 = cljs.core.seq.call(null,vars__$1);
var chunk__46153 = null;
var count__46154 = (0);
var i__46155 = (0);
while(true){
if((i__46155 < count__46154)){
var v = cljs.core._nth.call(null,chunk__46153,i__46155);
var temp__6738__auto___46157 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6738__auto___46157)){
var t_46158 = temp__6738__auto___46157;
each_fixture_fn.call(null,((function (seq__46152,chunk__46153,count__46154,i__46155,t_46158,temp__6738__auto___46157,v,each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46158)));
});})(seq__46152,chunk__46153,count__46154,i__46155,t_46158,temp__6738__auto___46157,v,each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1))
);
} else {
}

var G__46159 = seq__46152;
var G__46160 = chunk__46153;
var G__46161 = count__46154;
var G__46162 = (i__46155 + (1));
seq__46152 = G__46159;
chunk__46153 = G__46160;
count__46154 = G__46161;
i__46155 = G__46162;
continue;
} else {
var temp__6738__auto__ = cljs.core.seq.call(null,seq__46152);
if(temp__6738__auto__){
var seq__46152__$1 = temp__6738__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__46152__$1)){
var c__29660__auto__ = cljs.core.chunk_first.call(null,seq__46152__$1);
var G__46163 = cljs.core.chunk_rest.call(null,seq__46152__$1);
var G__46164 = c__29660__auto__;
var G__46165 = cljs.core.count.call(null,c__29660__auto__);
var G__46166 = (0);
seq__46152 = G__46163;
chunk__46153 = G__46164;
count__46154 = G__46165;
i__46155 = G__46166;
continue;
} else {
var v = cljs.core.first.call(null,seq__46152__$1);
var temp__6738__auto___46167__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6738__auto___46167__$1)){
var t_46168 = temp__6738__auto___46167__$1;
each_fixture_fn.call(null,((function (seq__46152,chunk__46153,count__46154,i__46155,t_46168,temp__6738__auto___46167__$1,v,seq__46152__$1,temp__6738__auto__,each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_46168)));
});})(seq__46152,chunk__46153,count__46154,i__46155,t_46168,temp__6738__auto___46167__$1,v,seq__46152__$1,temp__6738__auto__,each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1))
);
} else {
}

var G__46169 = cljs.core.next.call(null,seq__46152__$1);
var G__46170 = null;
var G__46171 = (0);
var G__46172 = (0);
seq__46152 = G__46169;
chunk__46153 = G__46170;
count__46154 = G__46171;
i__46155 = G__46172;
continue;
}
} else {
...
});})(each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1))
);
});})(each_fixture_fn,G__46151,env,once_fixtures,each_fixtures,vec__46148,ns,vars__$1))
], null);
