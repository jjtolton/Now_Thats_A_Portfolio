...
var depth = cljs.core.get.call(null,map__35627__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__35627__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__35630 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__35630__$1 = (((G__35630 == null))?null:cljs.core.persistent_BANG_.call(null,G__35630));
if((G__35630__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__35630__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__35631){
var vec__35636 = p__35631;
...
var frame = first__35638;
var frames = seq__35637__$1;
...
var or__28749__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__35639 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__35639,kvps);
} else {
return G__35639;
}
})();
...
var recursion = cljs.core.get.call(null,map__35642__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__35642__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_35644 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_35644){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_35644,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_35644))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__35646){
var vec__35654 = p__35646;
var seq__35655 = cljs.core.seq.call(null,vec__35654);
var first__35656 = cljs.core.first.call(null,seq__35655);
var seq__35655__$1 = cljs.core.next.call(null,seq__35655);
var parent = first__35656;
var frames = seq__35655__$1;
...
var found = cljs.core.not_empty.call(null,(function (){var G__35657 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__35657);
} else {
return G__35657;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__28737__auto__ = component_QMARK_;
...
var as_value = (function (){var G__35658 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__35658,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames){
return (function (p1__35645_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__35645_SHARP_]);
});})(G__35658,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__35654,seq__35655,first__35656,seq__35655__$1,parent,frames))
,G__35658);
} else {
return G__35658;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__35659 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__35659);
} else {
return G__35659;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__35660 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__35660,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__35660;
}
})());
...
var vec__35664 = spec;
var attr_key = cljs.core.nth.call(null,vec__35664,(0),null);
var opts = cljs.core.nth.call(null,vec__35664,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__35667){
var vec__35668 = p__35667;
var k = cljs.core.nth.call(null,vec__35668,(0),null);
var v = cljs.core.nth.call(null,vec__35668,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__35671){
var vec__35675 = p__35671;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__35678){
var vec__35685 = p__35678;
...
var frame = first__35687;
var frames = seq__35686__$1;
...
var vec__35688 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__35688,(0),null);
var datoms = cljs.core.nth.call(null,vec__35688,(1),null);
...
var attr = cljs.core.get.call(null,map__35694__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__35694__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__35696 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__35696,attr,eid);
} else {
return G__35696;
}
})();
...
var map__35699 = frame;
var map__35699__$1 = ((((!((map__35699 == null)))?((((map__35699.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35699.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35699):map__35699);
var eid = cljs.core.get.call(null,map__35699__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__35699__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__28749__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__28749__auto__)){
return or__28749__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__35701){
while(true){
var vec__35705 = p__35701;
...
var frame = first__35707;
var frames = seq__35706__$1;
var temp__6736__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__6736__auto__){
var eids = temp__6736__auto__;
...
var G__35708 = db;
var G__35709 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__35708;
p__35701 = G__35709;
continue;
}
...
while(true){
var G__35716 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__35716) {
case "expand":
var G__35723 = db;
var G__35724 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__35723;
frames = G__35724;
continue;
...
case "expand-rev":
var G__35725 = db;
var G__35726 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__35725;
frames = G__35726;
continue;
...
case "pattern":
var G__35727 = db;
var G__35728 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__35727;
frames = G__35728;
continue;
...
case "recursion":
var G__35729 = db;
var G__35730 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__35729;
frames = G__35730;
continue;
...
var f = first__35719;
var remaining = seq__35718__$1;
var result = (function (){var G__35720 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__35720);
} else {
return G__35720;
}
})();
...
var G__35731 = db;
var G__35732 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__35721 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__35721,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__35721;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__35733_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__35733_SHARP_);
})),eids);
return datascript.pull_api.pull_pattern.call(null,db,(function (){var x__29683__auto__ = datascript.pull_api.initial_frame.call(null,pattern,eids__$1,multi_QMARK_);
