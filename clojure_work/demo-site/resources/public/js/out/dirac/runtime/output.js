...
var pref_key = cljs.core.keyword.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("rich-text-ansi-style-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(command)].join(''));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("---<"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(dirac.runtime.output.ansi_code_to_style.call(null,sgr_code)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(">---")].join('');
}));
});
...
return clojure.string.join.call(null,cljs.core.map.call(null,(function (p1__61640_SHARP_){
if(cljs.core.truth_(dirac.runtime.output.style_QMARK_.call(null,p1__61640_SHARP_))){
return "%c";
} else {
return "%s";
}
