...
var or__28749__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj62309 = {"detail":data};
return obj62309;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28737__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28737__auto__)){
var and__28737__auto____$1 = (window["CustomEvent"]);
...
var args62314 = [];
var len__29970__auto___62320 = arguments.length;
var i__29971__auto___62321 = (0);
while(true){
if((i__29971__auto___62321 < len__29970__auto___62320)){
args62314.push((arguments[i__29971__auto___62321]));

var G__62322 = (i__29971__auto___62321 + (1));
i__29971__auto___62321 = G__62322;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args62314.length)].join('')));
...
var f = (function (){var pred__62317 = cljs.core._EQ_;
var expr__62318 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__62317.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__62318))){
return ((function (pred__62317,expr__62318){
return (function (p1__62310_SHARP_){
return console.warn(p1__62310_SHARP_);
});
;})(pred__62317,expr__62318))
} else {
if(cljs.core.truth_(pred__62317.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__62318))){
return ((function (pred__62317,expr__62318){
return (function (p1__62311_SHARP_){
return console.debug(p1__62311_SHARP_);
});
;})(pred__62317,expr__62318))
} else {
if(cljs.core.truth_(pred__62317.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__62318))){
return ((function (pred__62317,expr__62318){
return (function (p1__62312_SHARP_){
return console.error(p1__62312_SHARP_);
});
;})(pred__62317,expr__62318))
} else {
return ((function (pred__62317,expr__62318){
return (function (p1__62313_SHARP_){
return console.log(p1__62313_SHARP_);
});
;})(pred__62317,expr__62318))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__62324){
var map__62327 = p__62324;
var map__62327__$1 = ((((!((map__62327 == null)))?((((map__62327.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62327.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62327):map__62327);
var opts = map__62327__$1;
var eval_fn = cljs.core.get.call(null,map__62327__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__62329_SHARP_){
return new_def.callback(p1__62329_SHARP_);
});})(new_def))
);
...
return (function (p__62330){
var vec__62331 = p__62330;
var ky = cljs.core.nth.call(null,vec__62331,(0),null);
var v = cljs.core.nth.call(null,vec__62331,(1),null);
...
var args62334 = [];
var len__29970__auto___62337 = arguments.length;
var i__29971__auto___62338 = (0);
while(true){
if((i__29971__auto___62338 < len__29970__auto___62337)){
args62334.push((arguments[i__29971__auto___62338]));

var G__62339 = (i__29971__auto___62338 + (1));
i__29971__auto___62338 = G__62339;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args62334.length)].join('')));
...
if(cljs.core.truth_((function (){var and__28737__auto__ = typeof localStorage !== 'undefined';
