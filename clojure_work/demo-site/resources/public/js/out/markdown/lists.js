...
return clojure.string.join.call(null,(function (){var iter__29611__auto__ = (function markdown$lists$close_lists_$_iter__53543(s__53544){
return (new cljs.core.LazySeq(null,(function (){
var s__53544__$1 = s__53544;
while(true){
var temp__6738__auto__ = cljs.core.seq.call(null,s__53544__$1);
if(temp__6738__auto__){
var s__53544__$2 = temp__6738__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__53544__$2)){
var c__29609__auto__ = cljs.core.chunk_first.call(null,s__53544__$2);
var size__29610__auto__ = cljs.core.count.call(null,c__29609__auto__);
var b__53546 = cljs.core.chunk_buffer.call(null,size__29610__auto__);
if((function (){var i__53545 = (0);
while(true){
if((i__53545 < size__29610__auto__)){
var vec__53553 = cljs.core._nth.call(null,c__29609__auto__,i__53545);
var list_type = cljs.core.nth.call(null,vec__53553,(0),null);
cljs.core.chunk_append.call(null,b__53546,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("</li></"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(">")].join(''));

var G__53559 = (i__53545 + (1));
i__53545 = G__53559;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53546),markdown$lists$close_lists_$_iter__53543.call(null,cljs.core.chunk_rest.call(null,s__53544__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53546),null);
}
} else {
var vec__53556 = cljs.core.first.call(null,s__53544__$2);
var list_type = cljs.core.nth.call(null,vec__53556,(0),null);
return cljs.core.cons.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("</li></"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(">")].join(''),markdown$lists$close_lists_$_iter__53543.call(null,cljs.core.rest.call(null,s__53544__$2)));
}
} else {
return null;
}
...
return iter__29611__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__53560_SHARP_){
return (cljs.core.second.call(null,p1__53560_SHARP_) > num_indents);
...
var vec__53564 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__53564,(0),null);
var indents = cljs.core.nth.call(null,vec__53564,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__28749__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__53570 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__53570,(0),null);
var indents = cljs.core.nth.call(null,vec__53570,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__28749__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__28749__auto__)){
return or__28749__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__53573){
var map__53576 = p__53573;
var map__53576__$1 = ((((!((map__53576 == null)))?((((map__53576.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53576.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53576):map__53576);
var state = map__53576__$1;
var code = cljs.core.get.call(null,map__53576__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__53576__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__53576__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__53576__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__53576__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__28737__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__28737__auto__ = lists;
if(cljs.core.truth_(and__28737__auto__)){
var or__28749__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__28749__auto__)){
return or__28749__auto__;
} else {
return eof;
...
if(cljs.core.truth_((function (){var and__28737__auto__ = cljs.core.not.call(null,eof);
if(and__28737__auto__){
var and__28737__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__28737__auto__ = (function (){var or__28749__auto__ = eof;
if(cljs.core.truth_(or__28749__auto__)){
return or__28749__auto__;
} else {
