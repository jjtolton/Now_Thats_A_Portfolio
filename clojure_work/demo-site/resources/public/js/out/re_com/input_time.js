 ...
 */
re_com.input_time.triple__GT_time = (function re_com$input_time$triple__GT_time(p__54788){
var vec__54792 = p__54788;
var hr = cljs.core.nth.call(null,vec__54792,(0),null);
var _ = cljs.core.nth.call(null,vec__54792,(1),null);
var mi = cljs.core.nth.call(null,vec__54792,(2),null);
return ((hr * (100)) + mi);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(re_com.util.pad_zero_number.call(null,hrs,(2))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(":"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(re_com.util.pad_zero_number.call(null,mins,(2)))].join('');
});
/**
...
if(cljs.core.truth_((function (){var and__28737__auto__ = typeof model === 'number';
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("[input-time] given an invalid :model - "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(model)].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(and (number? model) (valid-time? model))")].join('')));
}

if(cljs.core.truth_((function (){var and__28737__auto__ = typeof minimum === 'number';
if(and__28737__auto__){
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("[input-time] given an invalid :minimum - "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(minimum)].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(and (number? minimum) (valid-time? minimum))")].join('')));
}

if(cljs.core.truth_((function (){var and__28737__auto__ = typeof maximum === 'number';
if(and__28737__auto__){
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("[input-time] given an invalid :maximum - "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(maximum)].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(and (number? maximum) (valid-time? maximum))")].join('')));
}

if((minimum <= maximum)){
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1("[input-time] :minimum "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(minimum),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > :maximum  "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(maximum)].join('')),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(<= minimum maximum)")].join('')));
}
...
if(cljs.core.truth_((function (){var and__28737__auto__ = callback;
...
var len__29970__auto___54802 = arguments.length;
var i__29971__auto___54803 = (0);
while(true){
if((i__29971__auto___54803 < len__29970__auto___54802)){
args__29977__auto__.push((arguments[i__29971__auto___54803]));

var G__54804 = (i__29971__auto___54803 + (1));
i__29971__auto___54803 = G__54804;
continue;
} else {
}
break;
...
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(argseq__29978__auto__);
});

re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic = (function (p__54796){
var map__54797 = p__54796;
...
var args = map__54797__$1;
var model = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var on_change = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var class$ = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__54797__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
if(cljs.core.truth_(((cljs.core.not.call(null,goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.input_time.input_time_args_desc),args,"input-time")))){
} else {
...
return ((function (deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function() { 
var G__54805__delegate = function (p__54799){
...
var args__$1 = map__54800__$1;
var model__$1 = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum__$1 = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum__$1 = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var width = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var disabled_QMARK_ = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var hide_border_QMARK_ = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var show_icon_QMARK_ = cljs.core.get.call(null,map__54800__$1,new cljs.core.Keyword(null,"show-icon?","show-icon?",-756836459));
if(cljs.core.truth_(((cljs.core.not.call(null,goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.input_time.input_time_args_desc),args__$1,"input-time")))){
} else {
throw (new Error("Assert failed: (validate-args-macro input-time-args-desc args \"input-time\")"));
}
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.h_box,new cljs.core.Keyword(null,"class","class",-2030961996),"rc-input-time",new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),height], null),style__$1),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"class","class",-2030961996),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("time-entry "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),width], null),style__$1),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,text_model),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),re_com.util.deref_or_value.call(null,disabled_QMARK_),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (style__$1,new_val,new_val__$1,new_val__$2,map__54800,map__54800__$1,args__$1,model__$1,minimum__$1,maximum__$1,width,height,disabled_QMARK_,hide_border_QMARK_,show_icon_QMARK_,deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function (event){
re_com.input_time.on_new_keypress.call(null,event,text_model);

return null;
});})(style__$1,new_val,new_val__$1,new_val__$2,map__54800,map__54800__$1,args__$1,model__$1,minimum__$1,maximum__$1,width,height,disabled_QMARK_,hide_border_QMARK_,show_icon_QMARK_,deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr))
,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),((function (style__$1,new_val,new_val__$1,new_val__$2,map__54800,map__54800__$1,args__$1,model__$1,minimum__$1,maximum__$1,width,height,disabled_QMARK_,hide_border_QMARK_,show_icon_QMARK_,deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function (event){
...
,new cljs.core.Keyword(null,"on-key-up","on-key-up",884441808),((function (style__$1,new_val,new_val__$1,new_val__$2,map__54800,map__54800__$1,args__$1,model__$1,minimum__$1,maximum__$1,width,height,disabled_QMARK_,hide_border_QMARK_,show_icon_QMARK_,deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr){
return (function (event){
...
var G__54806__i = 0, G__54806__a = new Array(arguments.length -  0);
while (G__54806__i < G__54806__a.length) {G__54806__a[G__54806__i] = arguments[G__54806__i + 0]; ++G__54806__i;}
  p__54799 = new cljs.core.IndexedSeq(G__54806__a,0);
} 
return G__54805__delegate.call(this,p__54799);};
G__54805.cljs$lang$maxFixedArity = 0;
G__54805.cljs$lang$applyTo = (function (arglist__54807){
var p__54799 = cljs.core.seq(arglist__54807);
return G__54805__delegate(p__54799);
});
G__54805.cljs$core$IFn$_invoke$arity$variadic = G__54805__delegate;
return G__54805;
})()
;
;})(deref_model,text_model,previous_model,map__54797,map__54797__$1,args,model,minimum,maximum,on_change,class$,style,attr))
});

re_com.input_time.input_time.cljs$lang$maxFixedArity = (0);

re_com.input_time.input_time.cljs$lang$applyTo = (function (seq54795){
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq54795));
});
