...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29406__auto__,writer__29407__auto__,opt__29408__auto__){
return cljs.core._write.call(null,writer__29407__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__6740__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__31760 = o;
(G__31760[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__31761__delegate = function (args){
...
while (G__31762__i < G__31762__a.length) {G__31762__a[G__31762__i] = arguments[G__31762__i + 0]; ++G__31762__i;}
  args = new cljs.core.IndexedSeq(G__31762__a,0);
} 
...
var args = cljs.core.seq(arglist__31763);
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,rendered_value,dom_value,node,temp__6742__auto__){
return (function (){
...
if(cljs.core.truth_((function (){var and__28737__auto__ = !((jsprops == null));
if(and__28737__auto__){
var and__28737__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__31769 = jsprops;
(G__31769["defaultValue"] = value);

(G__31769["onChange"] = ((function (G__31769,v,value,on_change){
return (function (p1__31766_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31766_SHARP_);
});})(G__31769,v,value,on_change))
);

(G__31769["ref"] = ((function (G__31769,v,value,on_change){
return (function (p1__31767_SHARP_){
return (this$["cljsInputElement"] = p1__31767_SHARP_);
});})(G__31769,v,value,on_change))
);
...
var vec__31776 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31776,(0),null);
var id = cljs.core.nth.call(null,vec__31776,(1),null);
var class$ = cljs.core.nth.call(null,vec__31776,(2),null);
...
var temp__6740__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__6740__auto__ == null)){
...
var jsprops = ({"argv": v});
var temp__6742__auto___31781 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6742__auto___31781 == null)){
} else {
var key_31782 = temp__6742__auto___31781;
(jsprops["key"] = key_31782);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__31784 = (new reagent.impl.template.NativeWrapper());
(G__31784["name"] = c);
...
var temp__6740__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__6740__auto__ == null)){
...
var len__29970__auto___31790 = arguments.length;
var i__29971__auto___31791 = (0);
while(true){
if((i__29971__auto___31791 < len__29970__auto___31790)){
args__29977__auto__.push((arguments[i__29971__auto___31791]));

var G__31792 = (i__29971__auto___31791 + (1));
i__29971__auto___31791 = G__31792;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29978__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31788){
var G__31789 = cljs.core.first.call(null,seq31788);
var seq31788__$1 = cljs.core.next.call(null,seq31788);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__31789,seq31788__$1);
});
...
break;
default:
var G__31796 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__31796;
continue;
...
var n__29770__auto___31799 = a.length;
var i_31800 = (0);
while(true){
if((i_31800 < n__29770__auto___31799)){
(a[i_31800] = reagent.impl.template.as_element.call(null,(a[i_31800])));

var G__31801 = (i_31800 + (1));
i_31800 = G__31801;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29770__auto___31802 = a.length;
var i_31803 = (0);
while(true){
if((i_31803 < n__29770__auto___31802)){
var val_31804 = (a[i_31803]);
if((cljs.core.vector_QMARK_.call(null,val_31804)) && ((reagent.impl.template.key_from_vec.call(null,val_31804) == null))){
(o["no-key"] = true);
} else {
}

(a[i_31803] = reagent.impl.template.as_element.call(null,val_31804));

var G__31805 = (i_31803 + (1));
i_31803 = G__31805;
continue;
} else {
}
...
var ctx = ({});
var vec__31809 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__31809,(0),null);
var derefed = cljs.core.nth.call(null,vec__31809,(1),null);
...
var G__31813 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31813) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__31813){
