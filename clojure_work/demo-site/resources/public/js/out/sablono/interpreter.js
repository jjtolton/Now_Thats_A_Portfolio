...
var m__29468__auto__ = (sablono.interpreter.interpret[goog.typeOf(x__29467__auto__)]);
if(!((m__29468__auto__ == null))){
return m__29468__auto__.call(null,this$);
} else {
var m__29468__auto____$1 = (sablono.interpreter.interpret["_"]);
...
var temp__6736__auto__ = (React.DOM[cljs.core.name.call(null,tag)]);
...
throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Unsupported HTML tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,tag))].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),tag], null));
}
});
...
var vec__50605 = sablono.util.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__50605,(0),null);
var attrs = cljs.core.nth.call(null,vec__50605,(1),null);
var content = cljs.core.nth.call(null,vec__50605,(2),null);
