...
var x__29467__auto__ = (((x == null))?null:x);
var m__29468__auto__ = (sablono.util.to_str[goog.typeOf(x__29467__auto__)]);
if(!((m__29468__auto__ == null))){
return m__29468__auto__.call(null,x);
} else {
var m__29468__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__29468__auto____$1 == null))){
return m__29468__auto____$1.call(null,x);
} else {
...
var x__29467__auto__ = (((x == null))?null:x);
var m__29468__auto__ = (sablono.util.to_uri[goog.typeOf(x__29467__auto__)]);
if(!((m__29468__auto__ == null))){
return m__29468__auto__.call(null,x);
} else {
var m__29468__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__29468__auto____$1 == null))){
return m__29468__auto____$1.call(null,x);
} else {
...
var len__29970__auto___50563 = arguments.length;
var i__29971__auto___50564 = (0);
while(true){
if((i__29971__auto___50564 < len__29970__auto___50563)){
args__29977__auto__.push((arguments[i__29971__auto___50564]));

var G__50565 = (i__29971__auto___50564 + (1));
i__29971__auto___50564 = G__50565;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__29978__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq50562){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50562));
});
...
var vec__50569 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__50571;
var words = seq__50570__$1;
...
var G__50573 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__50573,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__50573;
}
} else {
...
var args__29977__auto__ = [];
var len__29970__auto___50576 = arguments.length;
var i__29971__auto___50577 = (0);
while(true){
if((i__29971__auto___50577 < len__29970__auto___50576)){
args__29977__auto__.push((arguments[i__29971__auto___50577]));

var G__50578 = (i__29971__auto___50577 + (1));
i__29971__auto___50577 = G__50578;
continue;
} else {
}
break;
...
var argseq__29978__auto__ = ((((0) < args__29977__auto__.length))?(new cljs.core.IndexedSeq(args__29977__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__29978__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__50574_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__50574_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__50574_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__50574_SHARP_)){
return p1__50574_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__50574_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq50575){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50575));
});
...
var vec__50584 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__50584,(0),null);
var names = cljs.core.nth.call(null,vec__50584,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__50584,tag_name,names){
return (function (p1__50579_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__50579_SHARP_));
});})(matches,vec__50584,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__50584,tag_name,names){
return (function (p1__50580_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__50580_SHARP_));
});})(matches,vec__50584,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__50587){
var vec__50594 = p__50587;
var seq__50595 = cljs.core.seq.call(null,vec__50594);
var first__50596 = cljs.core.first.call(null,seq__50595);
var seq__50595__$1 = cljs.core.next.call(null,seq__50595);
var tag = first__50596;
var content = seq__50595__$1;
...
var vec__50597 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__50597,(0),null);
var id = cljs.core.nth.call(null,vec__50597,(1),null);
var class$ = cljs.core.nth.call(null,vec__50597,(2),null);
...
return cljs.core.symbol.call(null,"js",[cljs.core.str.cljs$core$IFn$_invoke$arity$1("React.DOM."),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,tag))].join(''));
});
/**
...
return cljs.core.re_pattern.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("\\s+"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,attr)),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\\s*=\\s*['\"][^\"']+['\"]")].join(''));
});
/**
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__28749__auto__ = x__$1.hasDomain();
