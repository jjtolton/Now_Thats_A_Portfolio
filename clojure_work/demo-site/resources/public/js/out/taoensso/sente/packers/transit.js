...
taoensso.sente.packers.transit.TransitPacker.cljs$lang$ctorPrWriter = (function (this__29406__auto__,writer__29407__auto__,opt__29408__auto__){
return cljs.core._write.call(null,writer__29407__auto__,"taoensso.sente.packers.transit/TransitPacker");
});
...
var args60973 = [];
var len__29970__auto___60979 = arguments.length;
var i__29971__auto___60980 = (0);
while(true){
if((i__29971__auto___60980 < len__29970__auto___60979)){
args60973.push((arguments[i__29971__auto___60980]));

var G__60981 = (i__29971__auto___60980 + (1));
i__29971__auto___60980 = G__60981;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args60973.length)].join('')));
...
var e_60983 = (function (){try{if((function (x){
...
taoensso.truss.impl._invar_violation_BANG_.call(null,true,"taoensso.sente.packers.transit",102,"([:el #{:json}] transit-fmt)",transit_fmt,e_60983,null);
}
...
}catch (e60977){if((e60977 instanceof Error)){
var e = e60977;
return e;
} else {
throw e60977;
