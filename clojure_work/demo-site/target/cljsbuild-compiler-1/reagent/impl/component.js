...
if((i < len)){
var k = (ks[i]);
var G__14330 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__14331 = (i + (1));
m = G__14330;
i = G__14331;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14335 = c;
var G__14335__$1 = (((G__14335 == null))?null:G__14335.prototype);
if((G__14335__$1 == null)){
return null;
} else {
return (G__14335__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14339 = c;
var G__14339__$1 = (((G__14339 == null))?null:G__14339.prototype);
if((G__14339__$1 == null)){
return null;
} else {
return (G__14339__$1["render"]);
}
})() == null)));
});
...
var G__14343 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14343) : reagent.impl.component.as_element.call(null,G__14343));
};
...
while (G__14346__i < G__14346__a.length) {G__14346__a[G__14346__i] = arguments[G__14346__i + 0]; ++G__14346__i;}
  args = new cljs.core.IndexedSeq(G__14346__a,0);
} 
...
var _STAR_current_component_STAR_14350 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14350;
}});
...
var G__14358 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__14358) {
...
return ((function (G__14358){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__14361 = reagent.impl.component.state_atom(c);
var G__14362 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__14361,G__14362) : cljs.core.reset_BANG_.call(null,G__14361,G__14362));
});
;})(G__14358))
...
var or__7601__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__7601__auto__){
...
var c = this;
var G__14364_14366 = (c["cljsRatom"]);
if((G__14364_14366 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14364_14366);
}
...
if(cljs.core.truth_((function (){var and__7589__auto__ = wrap;
...
var renders_14369 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14370 = cljs.core.first(cljs.core.vals(renders_14369));
if((cljs.core.count(renders_14369) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_14369))){
} else {
...
var render_fun__$1 = (function (){var or__7601__auto__ = render_fun;
if(cljs.core.truth_(or__7601__auto__)){
return or__7601__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__7601__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7601__auto__)){
return or__7601__auto__;
} else {
...
var name__$1 = (function (){var G__14368 = name;
switch (G__14368) {
case "":
...
var elem = (function (){var G__14379 = (function (){var or__7601__auto__ = (function (){var G__14381 = c;
if((G__14381 == null)){
return null;
} else {
return (G__14381["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7601__auto__)){
return or__7601__auto__;
...
return (G__14379["_currentElement"]);
}
})();
var name = (function (){var G__14382 = elem;
var G__14382__$1 = (((G__14382 == null))?null:(G__14382["type"]));
if((G__14382__$1 == null)){
return null;
} else {
return (G__14382__$1["displayName"]);
}
})();
var path = (function (){var G__14383 = elem;
var G__14383__$1 = (((G__14383 == null))?null:(G__14383["_owner"]));
var G__14383__$2 = (((G__14383__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__14383__$1) : reagent.impl.component.component_path.call(null,G__14383__$1)));
if((G__14383__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14383__$2),cljs.core.str.cljs$core$IFn$_invoke$arity$1(" > ")].join('');
}
})();
...
var n = (function (){var or__7601__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__7601__auto__)){
return or__7601__auto__;
} else {
var G__14385 = c;
var G__14385__$1 = (((G__14385 == null))?null:G__14385.constructor);
if((G__14385__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14385__$1);
}
}
})();
...
var temp__6740__auto__ = reagent.impl.component.cached_react_class(tag);
if((temp__6740__auto__ == null)){
