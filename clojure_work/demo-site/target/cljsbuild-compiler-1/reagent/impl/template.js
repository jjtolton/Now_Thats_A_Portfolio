...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8258__auto__,writer__8259__auto__,opt__8260__auto__){
return cljs.core._write(writer__8259__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__6740__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
if((temp__6740__auto__ == null)){
return (reagent.impl.template.prop_name_cache[cljs.core.name(k)] = reagent.impl.util.dash_to_camel(k));
} else {
var k_SINGLEQUOTE_ = temp__6740__auto__;
...
var G__14415 = o;
(G__14415[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14416__delegate = function (args){
...
while (G__14417__i < G__14417__a.length) {G__14417__a[G__14417__i] = arguments[G__14417__i + 0]; ++G__14417__i;}
  args = new cljs.core.IndexedSeq(G__14417__a,0);
} 
return G__14416__delegate.call(this,args);};
G__14416.cljs$lang$maxFixedArity = 0;
G__14416.cljs$lang$applyTo = (function (arglist__14418){
var args = cljs.core.seq(arglist__14418);
return G__14416__delegate(args);
});
...
var temp__6740__auto__ = (id_class["className"]);
if((temp__6740__auto__ == null)){
return p__$1;
} else {
var class$ = temp__6740__auto__;
...
var temp__6742__auto__ = (this$["cljsInputElement"]);
if((temp__6742__auto__ == null)){
return null;
} else {
var node = temp__6742__auto__;
...
return reagent.impl.batching.do_after_render(((function (node_value,rendered_value,dom_value,node,temp__6742__auto__){
return (function (){
...
});})(node_value,rendered_value,dom_value,node,temp__6742__auto__))
);
} else {
...
if(cljs.core.truth_((function (){var and__7589__auto__ = !((jsprops == null));
if(and__7589__auto__){
var and__7589__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__14424 = jsprops;
(G__14424["defaultValue"] = value);

(G__14424["onChange"] = ((function (G__14424,v,value,on_change){
return (function (p1__14421_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14421_SHARP_);
});})(G__14424,v,value,on_change))
);

(G__14424["ref"] = ((function (G__14424,v,value,on_change){
return (function (p1__14422_SHARP_){
return (this$["cljsInputElement"] = p1__14422_SHARP_);
});})(G__14424,v,value,on_change))
);
...
var vec__14431 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14431,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14431,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14431,(2),null);
...
var temp__6740__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__6740__auto__ == null)){
return reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null));
} else {
var k = temp__6740__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__6742__auto___14436 = reagent.impl.template.key_from_vec(v);
if((temp__6742__auto___14436 == null)){
} else {
var key_14437 = temp__6742__auto___14436;
(jsprops["key"] = key_14437);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14439 = (new reagent.impl.template.NativeWrapper());
(G__14439["name"] = c);
...
var temp__6740__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__6740__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag(x));
} else {
var s = temp__6740__auto__;
return s;
}
});
...
var G__14441 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14441) : reagent.impl.template.as_element.call(null,G__14441));
} else {
...
var len__8822__auto___14447 = arguments.length;
var i__8823__auto___14448 = (0);
while(true){
if((i__8823__auto___14448 < len__8822__auto___14447)){
args__8829__auto__.push((arguments[i__8823__auto___14448]));

var G__14449 = (i__8823__auto___14448 + (1));
i__8823__auto___14448 = G__14449;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8830__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14445){
var G__14446 = cljs.core.first(seq14445);
var seq14445__$1 = cljs.core.next(seq14445);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14446,seq14445__$1);
});
...
break;
default:
var G__14453 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14453;
continue;
...
var n__8622__auto___14456 = a.length;
var i_14457 = (0);
while(true){
if((i_14457 < n__8622__auto___14456)){
(a[i_14457] = reagent.impl.template.as_element((a[i_14457])));

var G__14458 = (i_14457 + (1));
i_14457 = G__14458;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8622__auto___14459 = a.length;
var i_14460 = (0);
while(true){
if((i_14460 < n__8622__auto___14459)){
var val_14461 = (a[i_14460]);
if((cljs.core.vector_QMARK_(val_14461)) && ((reagent.impl.template.key_from_vec(val_14461) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14460] = reagent.impl.template.as_element(val_14461));
...
var ctx = ({});
var vec__14466 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14466,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14466,(1),null);
...
var G__14470 = (cljs.core.count(argv) - first_child);
switch (G__14470) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14470){
