...
def convert_future(data_input, schedule):
    ...
    """
    year_data = main()
    data = [d for f in data_input] + [year_data, schedule]
    crn, course, title, _credits, _times, loc, instructor, seats, _open, enrolled, dates, year_data, schedule = data
